...
/**
 * Enum-like object matching reanimated's KeyboardState for useAnimatedKeyboard compat.
 * Named KeyboardState (value export) — types use IKeyboardState to avoid conflict.
 */
...
/**
 * A compatibility layer for migration from
